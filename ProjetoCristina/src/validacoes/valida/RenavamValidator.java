...
import validacoes.DigitoPara;
import validacoes.MessageProducer;
import validacoes.SimpleMessageProducer;
import validacoes.ValidationMessage;
import validacoes.formato.RenavamFormatter;
import validacoes.valida.error.RenavamError;
...
public class RenavamValidator implements Validator<String> {
     ...
     * 
     * @see validacoes.valida.Validator#assertValid(java.lang.Object)
     * 
     * @param renavam
